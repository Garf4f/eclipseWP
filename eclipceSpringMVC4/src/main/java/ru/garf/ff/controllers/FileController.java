...
import ru.garf.ff.exceptions.BadFileNameException;
import ru.garf.ff.objects.UploadedFile;
import ru.garf.ff.validators.FileValidator;
...
public class FileController {
	...
	@ResponseStatus(value = HttpStatus.BAD_REQUEST, reason = "IOException! check args!")

	@ExceptionHandler(IOException.class)
	public void handleIOException() {
		logger.error("IOException in app");
	}
